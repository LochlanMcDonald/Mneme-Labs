...
for (const [id, out] of [
  ...
  ['moment-insurer', 'post-moment-insurer-1080.png'],
  ['moment-investor', 'post-moment-investor-1080.png'],
  ['moment-soc2', 'post-moment-soc2-1080.png'],
  ['moment-phish', 'post-moment-phish-1080.png'],
  ['moment-key', 'post-moment-key-1080.png'],
  ['moment-laptop', 'post-moment-laptop-1080.png'],
